...
#define MAX_CYT_DIAMETER	0x14
#define MAX_CYT_PRESSURE	0xF0
...
struct cyttsp4_mt_data {
	...
	int prv_tch_type;
	bool check_finger_touch; /* change finger/glove mode */
	bool check_large_touch; /* detect suppression */
	bool request_glove_touch; /* detect suppression */
#ifdef VERBOSE_DEBUG
	u8 pr_buf[CY_MAX_PRBUF_SIZE];
#endif
	/* prevent double touch when change mode to finger from glove */
	struct timer_list pend_e_timer;
	bool pending_event_flag;
	bool pending_f_sync_flag;
};
