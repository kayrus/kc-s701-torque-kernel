...
#define CY_FW_FILE_01_NAME			"cyttsp4_fw_01.bin"
...
/* Timeout in ms. */
#define CY_COMMAND_COMPLETE_TIMEOUT	1500 /* for FW ver. 0200 later */
...
#define CY_CMD_TOUCHMODE_FINGER_ONLY 	0
#define CY_CMD_TOUCHMODE_AUTO_GLOVE 	1
