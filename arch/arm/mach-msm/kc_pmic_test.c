...
#define PM8926_VREG_LDO_NUM	25 /* PM8926 VREG LDO Number */
#define PM8926_VREG_SMPS_NUM	5  /* PM8926 VREG SMPS Number */
#define PM8926_VREG_VS_NUM	1  /* PM8926 VREG VS Number  */
#define PM8926_VREG_BOOST_NUM	0  /* PM8926 VREG BOOST Number  */

#define PM_VREG_LDO_NUM		PM8926_VREG_LDO_NUM
#define PM_VREG_SMPS_NUM	(PM8926_VREG_SMPS_NUM)
#define PM_VREG_VS_NUM		PM8926_VREG_VS_NUM
#define PM_VREG_BOOST_NUM	PM8926_VREG_BOOST_NUM
...
static const char *pin_type[3]
	= { "msm-gpio", "pm8226-gpio", "pm8226-mpp"};
...
vreg_setting_data vreg_data[PM_VREG_MAX_NUM] = {
	...
	/* PM8226 */
	{"8226_s1",	PMIC_VREG_SMPS,   500000, 1150000}, /* SMPS_1   */
	{"8226_s2",	PMIC_VREG_SMPS,  1200000, 1280000}, /* SMPS_2   */
	{"8226_s3",	PMIC_VREG_SMPS,  1200000, 1300000}, /* SMPS_3   */
	{"8226_s4",	PMIC_VREG_SMPS,  2100000, 2100000}, /* SMPS_4   */
	{"8226_s5",	PMIC_VREG_SMPS,  1150000, 1150000}, /* SMPS_5   */

	{"8226_l1",	PMIC_VREG_LDO,   1225000, 1225000}, /* LDO_L1   */
	{"8226_l2",	PMIC_VREG_LDO,   1200000, 1275000}, /* LDO_L2   */
	{"8226_l3",	PMIC_VREG_LDO,    750000, 1275000}, /* LDO_L3   */
	{"8226_l4",	PMIC_VREG_LDO,   1200000, 1200000}, /* LDO_L4   */
	{"8226_l5",	PMIC_VREG_LDO,   1200000, 1200000}, /* LDO_L5   */
	{"8226_l6",	PMIC_VREG_LDO,   1800000, 1800000}, /* LDO_L6   */
	{"8226_l7",	PMIC_VREG_LDO,   1850000, 1850000}, /* LDO_L7   */
	{"8226_l8",	PMIC_VREG_LDO,   1800000, 1800000}, /* LDO_L8   */
	{"8226_l9",	PMIC_VREG_LDO,   2050000, 2050000}, /* LDO_L9   */
	{"8226_l10",	PMIC_VREG_LDO,   1800000, 1800000}, /* LDO_L10  */
														/* LDO_L11  */
	{"8226_l12",	PMIC_VREG_LDO,   1800000, 1800000}, /* LDO_L12  */
														/* LDO_L13  */
	{"8226_l14",	PMIC_VREG_LDO,   2750000, 2750000}, /* LDO_L14  */
	{"8226_l15",	PMIC_VREG_LDO,   2800000, 2800000}, /* LDO_L15  */
	{"8226_l16",	PMIC_VREG_LDO,   3000000, 3300000}, /* LDO_L16  */
	{"8226_l17",	PMIC_VREG_LDO,   2950000, 2950000}, /* LDO_L17  */
	{"8226_l18",	PMIC_VREG_LDO,   2950000, 2950000}, /* LDO_L18  */
	{"8226_l19",	PMIC_VREG_LDO,   2850000, 2850000}, /* LDO_L19  */
	{"8226_l20",	PMIC_VREG_LDO,   3075000, 3075000}, /* LDO_L20  */
	{"8226_l21",	PMIC_VREG_LDO,   2950000, 2950000}, /* LDO_L21  */
	{"8226_l22",	PMIC_VREG_LDO,   2950000, 2950000}, /* LDO_L22  */
	{"8226_l23",	PMIC_VREG_LDO,   2850000, 2850000}, /* LDO_L23  */
	{"8226_l24",	PMIC_VREG_LDO,   1300000, 1300000}, /* LDO_L24  */
														/* LDO_L25  */
	{"8226_l26",	PMIC_VREG_LDO,   1225000, 1225000}, /* LDO_L26  */
	{"8226_l27",	PMIC_VREG_LDO,   2050000, 2050000}, /* LDO_L27  */
	{"8226_l28",	PMIC_VREG_LDO,   2950000, 2950000}, /* LDO_L28  */

	{"8226_lvs1",	PMIC_VREG_VS,          0,       0}, /* VS_LVS1  */
};
